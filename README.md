...
### 一键安装
```
bash <(curl -Ls https://raw.githubusercontent.com/AZZ-vopp/xrayrold/master/install.sh && bash install.sh
```
### 使用Docker部署软件
...
[Mozilla Public License Version 2.0](https://github.com/AZZ-vopp/xrayrold/blob/master/LICENSE)
